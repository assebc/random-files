...
def progressive_tax(amount):
    """Calculate progressive tax according to 2026 brackets."""
    if amount <= 0:
        return 0.0
    tax = 0.0
    lower = 0.0
    for limit, rate in IRS_2026_BRACKETS:
...
try:
    ...
    calculate_irs_2026_with_irs_jovem(gross_income, jovem_year)
